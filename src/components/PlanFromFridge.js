    ...
    <div className="min-h-screen bg-gray-50 py-12 px-6">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-8">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="bg-white rounded-full p-4 shadow-lg mb-4">
              <img
                src="/path/to/your/take-photo-icon.png"
                alt="Take a photo"
                className="w-16 h-16"
              />
            </div>
            <p className="text-lg text-gray-700 font-medium">Take a photo of your ingredients</p>
          </div>
          <div className="hidden md:block text-purple-700 text-3xl">→</div>
          <div className="flex flex-col items-center text-center">
            <div className="bg-white rounded-full p-4 shadow-lg mb-4">
              <img
                src="/path/to/your/upload-icon.png"
                alt="Upload photo"
                className="w-16 h-16"
              />
            </div>
            <p className="text-lg text-gray-700 font-medium">Upload your photo</p>
          </div>
          <div className="hidden md:block text-purple-700 text-3xl">→</div>
          <div className="flex flex-col items-center text-center">
            <div className="bg-white rounded-full p-4 shadow-lg mb-4">
            ...
            <p className="text-lg text-gray-700 font-medium">Receive recipes tailored to your ingredients!</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white shadow-lg rounded-lg w-full max-w-2xl mx-auto p-8">
        <h2 className="text-3xl font-bold text-purple-700 text-center mb-6">
          Recipe from Ingredients in Your Fridge!
        </h2>
